class RU_EMR {
    ...
    class Type {
        ...
        class medic_F {
        	...
        	backpack = "rhs_assault_umbts";
        	addItemsToBackpack[] = {LIST_20("ACE_fieldDressing"),LIST_10("ACE_fieldDressing"),LIST_10("ACE_epinephrine"),LIST_20("ACE_morphine"),LIST_5("ACE_bloodIV_500"),LIST_6("rhs_mag_rdg2_white")};
        	headgear = "rhs_6b27m_green";
        };
        ...
        class Soldier_GL_F {
        	...
        	addItemsToVest[] = {LIST_2("rhs_mag_rgn"),LIST_9("rhs_30Rnd_545x39_AK")};
        	backpack = "rhs_assault_umbts";
        	addItemsToBackpack[] = {LIST_4("rhs_mag_rdg2_white"),LIST_4("rhs_GRD40_White"),LIST_4("rhs_GRD40_Red"),LIST_4("rhs_mag_rgo")};
        	headgear = "rhs_6b27m_green";
        };
    };
};
