class US_OCP {
    ...
    class Type {
        ...
        class Soldier_F {
        	...
        	addItemsToUniform[] = {LIST_12("ACE_fieldDressing"),LIST_5("ACE_morphine"),"ACE_epinephrine","ACE_MapTools",LIST_2("ACE_CableTie")};
        ...
        class medic_F {
        	...
        	backpack = "rhsusf_assault_eagleaiii_ocp";
        	addItemsToBackpack[] = {LIST_20("ACE_fieldDressing"),LIST_10("ACE_fieldDressing"),LIST_20("ACE_morphine"),LIST_10("ACE_epinephrine"),LIST_5("ACE_bloodIV_500")};
        	headgear = "rhsusf_ach_helmet_headset_ocp";
        };
        ...
        class Soldier_GL_F {
        	...
        	addItemsToVest[] = {"rhsusf_mag_15Rnd_9x19_JHP",LIST_6("rhs_mag_m67"),LIST_9("rhs_mag_30Rnd_556x45_Mk262_Stanag"),LIST_5("1Rnd_Smoke_Grenade_shell")};
        	headgear = "rhsusf_ach_helmet_headset_ocp";
        };
    };
};
